...
while 1:
    ...
    if is_odd(first_input) and is_more_or_equal_1(first_input): # Here we tell it umber is odd and Number is equal or greater than 3, correct, lets play
        ...
        while played < max_rounds:
            ...
            if (machine == "rock" and user ==("paper" or "spock")) or (machine == "paper" and user == ("scissors" or  "lizard")) or (machine == "scissors" and user == ("rock" or "spock")) or (machine == "lizard" and user == ("rock" or "scissors")) or (machine == "spock" and user == ("paper" or "lizard")):
                users_win+=1
            elif machine == user:
                print("\nTIE!!!")
            else:
